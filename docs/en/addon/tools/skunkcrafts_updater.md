...
The Linux binary is a single file named `SkunkcraftsUpdater_lin`. Place it in the X-Plane root directory (the folder containing `X-Plane-x86_64`) and make it executable:
