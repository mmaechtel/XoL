...
SimScreen Overlay is a [FlyWithLua](flywithlua.md) script that adds a clean flight information overlay to X-Plane 12 screenshots. The overlay appears only during the screenshot capture — no visual clutter while flying.
...
- **Dependencies:** [FlyWithLua NG+](flywithlua.md), SimBrief account (optional, for automatic flight data import)
