...
- **[SkunkCrafts Updater](../tools/skunkcrafts_updater.md):** Automatische Updates werden unterstützt
...
**Voraussetzung:** [XPPython3](../scripting/xppython3.md) (ab Version 4.5). XPPython3 enthält einen eigenen Python-Interpreter — eine separate Python-Installation ist nicht erforderlich.
