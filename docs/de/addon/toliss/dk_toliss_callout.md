...
- **Kompatibilität:** X-Plane 12 — letztes Release Juni 2024, seitdem unverändert
...
Keine Linux-spezifischen Probleme bekannt. Das Skript nutzt X-Planes eingebautes TTS über `XPLMSpeakString()`. Für hörbare Ausgabe unter Linux ist [XLinSpeak](../tools/xlinspeak.md) erforderlich.
