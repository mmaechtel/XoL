...
Die ZIP-Datei nach `Resources/plugins/` entpacken. Nach der Erstinstallation übernimmt der [SkunkCrafts Updater](skunkcrafts_updater.md) automatische Updates (PROD- oder BETA-Kanal).
