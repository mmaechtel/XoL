...
[XPPython3](xppython3.md) muss bereits installiert sein. Vor der Installation eine eventuell vorhandene ältere Version vollständig löschen (nicht überschreiben). Die ZIP-Datei nach `Resources/plugins/PythonPlugins/` entpacken:
