...
SimScreen Overlay ist ein [FlyWithLua](flywithlua.md)-Skript, das X-Plane-12-Screenshots mit einem sauberen Fluginformations-Overlay versieht. Das Overlay erscheint nur während der Screenshot-Aufnahme — keine visuelle Störung beim Fliegen.
