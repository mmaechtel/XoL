---
description: "Little XpConnect verbindet X-Plane mit Little Navmap unter Linux: Echtzeit-Position, Wetter und KI-Verkehrsdaten via Shared Memory oder Netzwerk."
---
# Little XpConnect
