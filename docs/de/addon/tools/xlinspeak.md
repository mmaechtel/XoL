...
- Piper-TTS-Binary — [TheLouisHong/piper](https://github.com/TheLouisHong/piper/releases) Fork nutzen (piper_linux_x86_64.tar.gz); das OHF-Voice/piper1-gpl-Upstream liefert nur Python-Wheels
