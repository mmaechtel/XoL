...
2. **Felder, die ausgefüllt werden müssen**:
    ...
    * **Station ID** (rechts unten): Hier kommt die **Hoppie ID** des ATC-Controllers rein, bei VATSIM z. B. `EDDH`. Informationen dazu finden sich auch oft in der ATIS des Flughafens und natürlich bei [Hoppie direkt](https://www.hoppie.nl/acars/system/online.html). 
