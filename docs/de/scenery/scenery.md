...
Für die Erstellung und Verwaltung von Szenerien stehen verschiedene Tools zur Verfügung. [Ortho4XP](ortho4xp.md) ermöglicht die Erstellung eigener Orthofoto-Szenerien, während [AutoOrtho](autoortho.md) automatische Orthofoto-Szenerien bereitstellt. [XRoad](../addon/xroad.md) bietet verbesserte Straßennetze für eine realistischere Darstellung der Infrastruktur.
