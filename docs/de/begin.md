...
1. [Performance-Grundlagen](performance_overview.md) — Die drei Lastdimensionen verstehen (CPU, I/O, Netzwerk)
2. [NVIDIA-Treiber](nvidia.md) — Proprietäre NVIDIA-Treiber installieren und konfigurieren
3. [Liquorix-Kernel](liquorix.md) — Low-Latency-Kernel optimiert für Desktop-Workloads
4. [System-Tuning](systemtuning.md) — CPU-Governor, Interrupt-Shielding und Kernel-Parameter
5. [Display-Server](displayserver.md) — Wayland vs. X11 für X-Plane
