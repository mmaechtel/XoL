...
Für die Erstellung und Verwaltung von Szenerien stehen verschiedene Tools zur Verfügung. [Ortho4XP](../addon/ortho4xp.md) ermöglicht die Erstellung eigener Orthofoto-Szenerien, während [AutoOrtho](../addon/autoortho.md) automatische Orthofoto-Szenerien bereitstellt. [XRoad](../addon/xroad.md) bietet verbesserte Straßennetze für eine realistischere Darstellung der Infrastruktur.
