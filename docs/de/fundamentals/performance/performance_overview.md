...
Siehe [Systemtuning](../../linux/system/systemtuning.md) für IRQ-Pinning und [CPU-Affinität](../../glossary.md#cpu-affinität)
...
Siehe [Dateisystem](../../linux/optimizations/filesystem.md) für I/O-Scheduler, [noatime](../../glossary.md#noatime) und [TRIM](../../glossary.md#trim)-Konfiguration
...
- Siehe [AutoOrtho](../../scenery/ortho_streaming/autoortho.md) und [Dateisystem](../../linux/optimizations/filesystem.md)
...
- Siehe [System Monitoring](../../linux/system/systemtools.md)

## Weiterführende Kapitel

| Thema | Seite | Schwerpunkt |
|---|---|---|
| System-Tuning | [Einführung](../../linux/system/index.md) | Überblick und Video |
