---
description: "Z-Shell-Einrichtung unter Linux: Installation, Oh My Zsh, Autovervollständigung, Syntax-Highlighting und nützliche Plugins für die Systemarbeit."
---
# Z Shell (zsh)
