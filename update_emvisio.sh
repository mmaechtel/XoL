...
# Note: Maps.html is generated by MkDocs (from docs/*/Maps.md) — do NOT overwrite it
...
#   --filter='P ...'  Protect from deletion but allow transfer when present
RSYNC_OPTS=(
    -avz
    --delete
    --exclude='stats/'
    --exclude='Maps/'
    --filter='protect vatsim_routes.html'
)
